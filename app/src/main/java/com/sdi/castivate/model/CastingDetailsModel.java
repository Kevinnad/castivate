...
/*{
  ...
  "casting_email": "realitytalent@realtvcasting.com"
	...
	public int abuse_flag;
	public int casting_id;
	...
	public CastingDetailsModel(String roleId, String castingTitle,
			...
			String state, String country,String castingEmail,String applyFlag ,int abuse_flag,int casting_id,String isNew) {
		super();
		this.roleId = roleId;
