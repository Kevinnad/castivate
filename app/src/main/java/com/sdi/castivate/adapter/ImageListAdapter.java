...
public class ImageListAdapter extends ArrayAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        try {
           ...
           /* UrlImageViewHelper.setUrlDrawable((ImageView) convertView, imageUrls.get(position).imgThumb, new UrlImageViewCallback() {
                @Override
...
*/
            Glide.with(context).load(imageUrls.get(position).imageRole).placeholder(R.drawable.dd)
