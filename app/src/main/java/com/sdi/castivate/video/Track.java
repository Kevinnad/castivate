...
public class Track {
    ...
    private ArrayList<SampleCompressor> samples = new ArrayList<SampleCompressor>();
    ...
    public void addSample(long offset, MediaCodec.BufferInfo bufferInfo) {
        ...
        samples.add(new SampleCompressor(offset, bufferInfo.size));
    ...
    public ArrayList<SampleCompressor> getSamples() {
        return samples;
    }
