...
public class PostCastivity extends Activity implements View.OnClickListener, HorizontalNumberPickerListener {
    LocationSearchAdapter searchAdapter = null;
    int front = 0, back = 0, side = 0, video = 0, audio = 0, checkedval = 0;
    HorizontalNumberPicker horizontal_number_picker1;
    HorizontalNumberPicker horizontal_number_picker2;
    HorizontalNumberPicker horizontal_number_picker3;
    HorizontalNumberPicker horizontal_number_picker4;
    HorizontalNumberPicker horizontal_number_picker5;
    CheckBox check;
    LinearLayout linear_special;
    RelativeLayout front_lay, back_lay, side_lay, audio_lay, video_lay;
...
//zipCode
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        linear_special = (LinearLayout) findViewById(R.id.linear_special);
        front_lay = (RelativeLayout) findViewById(R.id.front_lay);
        back_lay = (RelativeLayout) findViewById(R.id.back_lay);
        side_lay = (RelativeLayout) findViewById(R.id.side_lay);
        audio_lay = (RelativeLayout) findViewById(R.id.audio_lay);
        video_lay = (RelativeLayout) findViewById(R.id.video_lay);
        horizontal_number_picker1 = (HorizontalNumberPicker) findViewById(R.id.horizontal_number_picker1);
        horizontal_number_picker2 = (HorizontalNumberPicker) findViewById(R.id.horizontal_number_picker2);
        horizontal_number_picker3 = (HorizontalNumberPicker) findViewById(R.id.horizontal_number_picker3);
        horizontal_number_picker4 = (HorizontalNumberPicker) findViewById(R.id.horizontal_number_picker4);
        horizontal_number_picker5 = (HorizontalNumberPicker) findViewById(R.id.horizontal_number_picker5);
        ...
        check.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean b) {
                if (b) {
                    linear_special.setVisibility(View.VISIBLE);
                    checkedval = 1;

                } else {
                    linear_special.setVisibility(View.GONE);
                    front = 0;
                    back = 0;
                    side = 0;
                    video = 0;
        ...
        back = horizontal_number_picker1.getValue();
        front = horizontal_number_picker2.getValue();
        side = horizontal_number_picker3.getValue();
        audio = horizontal_number_picker4.getValue();
        video = horizontal_number_picker5.getValue();


        horizontal_number_picker1.setListener(this);
        horizontal_number_picker1.setMaxValue(3);
        horizontal_number_picker1.setMinValue(0);
        horizontal_number_picker1.getButtonMinusView().setText("<");
        horizontal_number_picker1.getButtonPlusView().setText(">");
        horizontal_number_picker1.getTextValueView().setTextColor(getResources().getColor(android.R.color.holo_red_light));
        //horizontal_number_picker1.getTextValueView().setTextSize(22);


        horizontal_number_picker2.setListener(this);
        horizontal_number_picker2.setMaxValue(3);
        horizontal_number_picker2.setMinValue(0);
        horizontal_number_picker2.getButtonMinusView().setText("<");
        horizontal_number_picker2.getButtonPlusView().setText(">");
        horizontal_number_picker2.getTextValueView().setTextColor(getResources().getColor(android.R.color.holo_red_light));


        horizontal_number_picker3.setListener(this);
        horizontal_number_picker3.setMaxValue(3);
        horizontal_number_picker3.setMinValue(0);
        horizontal_number_picker3.getButtonMinusView().setText("<");
        horizontal_number_picker3.getButtonPlusView().setText(">");
        horizontal_number_picker3.getTextValueView().setTextColor(getResources().getColor(android.R.color.holo_red_light));


        horizontal_number_picker4.setListener(this);
        horizontal_number_picker4.setMaxValue(3);
        horizontal_number_picker4.setMinValue(0);
        horizontal_number_picker4.getButtonMinusView().setText("<");
        horizontal_number_picker4.getButtonPlusView().setText(">");
        horizontal_number_picker4.getTextValueView().setTextColor(getResources().getColor(android.R.color.holo_red_light));


        horizontal_number_picker5.setListener(this);
        horizontal_number_picker5.setMaxValue(3);
        horizontal_number_picker5.setMinValue(0);
        horizontal_number_picker5.getButtonMinusView().setText("<");
        horizontal_number_picker5.getButtonPlusView().setText(">");
        horizontal_number_picker5.getTextValueView().setTextColor(getResources().getColor(android.R.color.holo_red_light));
    ...
    public void onHorizontalNumberPickerChanged(HorizontalNumberPicker horizontalNumberPicker, int value) {
        switch (horizontalNumberPicker.getId()) {
            ...
            case R.id.horizontal_number_picker3:
                side = value;
                break;
            case R.id.horizontal_number_picker4:
                audio = value;
                break;
            case R.id.horizontal_number_picker5:
                video = value;
                break;
        ...
        if (Network.isNetworkConnected(context)) {
            ...
            if (strCastivityType.length() > 0 && strEthnicityType.length() > 0
                ...
                if (checkedval == 0) {
                    ...
                    if (front == 0 && side == 0 && audio == 0 && video == 0 && back == 0) {
                        Library.alert(context,"You have selected special requirement, please mention the number of special requirements in the required categories.");
                    } else {
                        handlerSubmitCastingSync.sendEmptyMessage(0);
    ...
    public class PostSubmitCastingASync extends AsyncTask<String, Void, Void> {
        ...
        public void onPostExecute(Void params) {
            if (pDialog.isShowing())
                pDialog.dismiss();
            if (json != null) {
                alert(context, "Your casting has been added successfully");
                JSONObject props = new JSONObject();
                try {
                    props.put("User ID", Library.getUserId(context));
        ...
        try {
            ...
            try {
                ...
                item = new JSONStringer()
                        .object()
                        .key("userId")
                        .value(Library.getUserId(context))
                        .key("castingTitle")
                        ...
                        .key("isSpecialRecruitment").value(checkedval + "")
                        .key("photo_frontview").value(front + "")
                        .key("photo_backview").value(back + "")
                        .key("photo_sideview").value(side + "")
                        .key("voice").value(audio + "")
