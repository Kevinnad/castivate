...
public abstract class BaseCaptureActivity extends AppCompatActivity implements BaseCaptureInterface {
    ...
    @IntDef({FLASH_MODE_OFF, FLASH_MODE_ALWAYS_ON})
    @Retention(RetentionPolicy.SOURCE)
    ...
    public int iconRearCamera() {
        return getIntent().getIntExtra(CameraIntentKey.ICON_REAR_CAMERA, R.drawable.rear_icon);
    }

    @DrawableRes
    @Override
    public int iconFrontCamera() {
        return getIntent().getIntExtra(CameraIntentKey.ICON_FRONT_CAMERA, R.drawable.rear_icon);
    }

    @DrawableRes
    @Override
    public int iconStop() {
        return getIntent().getIntExtra(CameraIntentKey.ICON_STOP, R.drawable.record_finish);
    }

    @DrawableRes
    @Override
    public int iconRecord() {
        return getIntent().getIntExtra(CameraIntentKey.ICON_RECORD, R.drawable.record_icon);
    }
    ...
    public int iconStillshot() {
        return getIntent().getIntExtra(CameraIntentKey.ICON_STILL_SHOT, R.drawable.record_icon);
    }
